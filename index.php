...
<body>
    <div class="container-fluid">
        <section id="page1" class="row align-items-start justify-content-center">
            <div class="img d-flex justify-content-center align-items-center">
                <h1 class="text-center">Sebastian y Gina</h1>
            </div>
            <div class="part2 d-flex justify-content-start align-items-center flex-column vh-100">
                <h1 class="text-center">Sebastian y Gina</h1>
            ...
            <form class="d-flex justify-content-center align-items-center flex-column gap-4" method="POST" action="confirmar.php">
                ...
                <div>
                    <div class="d-flex justify-content-center gap-3">
                        <div><input type="radio" name="respuesta" value="si" checked><label for="si">Si</label></div>
                        <div><input type="radio" name="respuesta" value="no"><label for="no">No</label></div>
                    </div>
                </div>
