    ...
    <div class="container-fluid px-0">
        ...
        <section id="page4" class="row d-none">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="d-flex justify-content-center align-items-center flex-column gap-4 w-100 h-100 m-0">
                ...
                <div class="d-flex justify-content-center align-items-center flex-column gap-4 w-100 m-0 h-100">
                    <img src="./img/girls.jpg" class="col-5 rounded-5" style="height: 100%;">
